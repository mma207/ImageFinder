...
var client_id = "spWtFQ8sNrBp4gLHZ48_rRSxlXdHx5uiF7AQsU8Eixg"; // let key = process.env.CLIENT_ID
// search term 

var searchTerm = document.querySelector("#search-term"); // page 

var page = 1; // fetch photos 

var getData = function getData(query) {
  fetch("https://api.unsplash.com/search/photos?client_id=".concat(client_id, "&query=").concat(query, "&page=").concat(page)).then(function (r) {
    return r.json();
  }).then(function (imageArray) {
    //    let max = imageArray.total_pages 
    imageArray.results.forEach(function (image) {
...
var prevFunctionality = function prevFunctionality(query) {
...
var nextFunctionality = function nextFunctionality(query) {
...
var modalFunctionality = function modalFunctionality(imageIcon, image) {
  imageIcon.addEventListener("click", function () {
    ...
    var modalCaption = document.createElement("h4");
...
var imageCollection = document.querySelector(".collection");
